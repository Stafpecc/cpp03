...
ClapTrap::ClapTrap() : _name(), _hitPoint(10), _energyPoint(10) {
    std::cout << "ClapTrap default constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _hitPoint(10), _energyPoint(10){
    std::cout << "ClapTrap constructor called" << std::endl;
    _name = name;
}

ClapTrap::ClapTrap(const ClapTrap &other) : _hitPoint(10), _energyPoint(10){
